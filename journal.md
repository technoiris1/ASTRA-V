...
## entry 2
yo! there hasnt been any update on this project for a pretty long time, the main reason is that I'm too swamped with other things and I need to completely redesigng the whole mechanism. So far I was trying to make a rocket motor at home all by myself but thats not something which one should be doing in their bedroom, its extremely dangerous and can wipe me out of existence if i mess up, so i talked in a few online rocketry communities and every advice i received was that you should start with basic solid fuel, which is true. But the issue is that you can't achieve a controlled flow with solid propellant, it will blow off and only stop when it's over. So I came up with a new thing, what if we just use solid propellant to push the rocket up and throw it in the air and then use brushless motors with propellers to make it land, so like just 4 hands pop out with motors at the time of landing and help it land smoothly, this is a lot of achievable thing than what i was working, this project is something i really wanna see happen and land properly, im setting a goal of 1st august to complete it and make it land rn. Today is 22nd March, so I have a little over 4 months. cya o7
